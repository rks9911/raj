...
public class HomeController {
	...
	@RequestMapping(value = "findbypagination", method = RequestMethod.GET)
	public String findByPagination(@RequestParam("id") Integer Id, Model model) {
		System.out.println("Working");
		model.addAttribute("myList",homeService.findByPagination(Id));
		return "home";
	}
}
